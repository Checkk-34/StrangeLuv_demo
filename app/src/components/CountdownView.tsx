...
/* 3 色阶插值：黎明金 → 午后珊瑚 → 深夜玫瑰 */
const COLOR_A = { r: 212, g: 168, b: 87 };  // gold-amber   #D4A857 — 清晨
const COLOR_B = { r: 255, g: 154, b: 107 }; // sunset-coral #FF9A6B — 午后
const COLOR_C = { r: 255, g: 107, b: 138 }; // heart-rose   #FF6B8A — 深夜
  ...
  return (
    <div className="h-full w-full flex flex-col items-center justify-center select-none px-8 md:px-12 xl:px-16">
      <div className="flex flex-col items-center">
        ...
        {/* 副文本 */}
        <p className="font-en text-[16px] md:text-[18px] tracking-[0.06em] font-light" style={{ color, opacity: 0.4 }}>
